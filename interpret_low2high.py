...
def main():
  ...
  #     ax.set_rgrids([-0.5, 0, 0.5, 1, 1.5, 2]) ## for haswell lr only
      ...
      plt.savefig('output/fig/low2high/{}/radar_{}.pdf'.format(ac[0], wl),bbox_inches='tight') 
  ...
  plt.savefig("output/fig/low2high/{}/conf_{}.pdf".format(ac_tar[0], workload),bbox_inches='tight')
